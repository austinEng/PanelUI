...
// loop over refs
var loopOverChildren = function(nodeRef, hcb, vcb) {
...
var recalculateSpace = function(state, parRef) {
...
var PanelWindow = React.createClass({
  ...
  handleSplitterDown: function(event) {
  ...
  handleSplitterDrag: function(event) {
  ...
  render: function() {
    ...
    if (!this.state.activeSplitter) {
      ...
      return (
        <div className='panel-window' onMouseMove={this.handleSplitterDrag} onMouseUp={this.clearSplitter}>
          <PanelGroup
          ref='root' 
          idx={this.state.root} 
          width={current.width} 
